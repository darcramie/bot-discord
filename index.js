...
Client.on("guildMemberAdd", async member => {
    ...
    Client.channels.cache.get("944639463747907604").send("<@" + member.id +  "> est arrivée sur le serveur ");
...
Client.on("guildMemberRemove", member => {
    ...
    Client.channels.cache.get("944639582543171656").send(member.displayName + "vient de quitter le serveur :sob: ");
})
    ...
    if(message.member.permissions.has("ADMINISTRATOR")){
        if(message.content.startsWith(prefix + "ban")){
            ...
            if(mention == undefined){
                ...
                mention.roles.add("959445829507252277");
        ...
        if(mention == undefined){
            ...
            mention.roles.remove("959445829507252277");
